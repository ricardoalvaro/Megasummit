<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="aspnetPurchaseInvoice.aspx.cs" Inherits="MegaSummitInventorySystem.aspnetPurchaseInvoice" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#btn-new").click(function () {
                window.location = "aspnetPurchaseInvoiceInformation.aspx";
            });
        ...
        function RedirectToGeneralInfomation(purchase_invoice_id) {
            window.location = "aspnetPurchaseInvoiceInformation.aspx?purchaseInvoiceID=" + purchase_invoice_id;
        }
