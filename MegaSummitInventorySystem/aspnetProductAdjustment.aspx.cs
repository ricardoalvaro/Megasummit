...
{
    public partial class aspnetProductAdjustment : System.Web.UI.Page
    {
        ...
        {
            var data = Database._InventoryAdjustmentSelect(0);
        ...
        public string AutoCompleteReasonAdjustment()
        {
            try
            {
                Database = new DatabaseDataContext();
