<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="aspnetCompany-Reminder-UndepositFunds.aspx.cs" Inherits="MegaSummitInventorySystem.aspnetCompany_Reminder_UndepositFunds" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
...
</div><div id="main" class="company-reminders-undeposit-funds">
    <div class="ym-wrapper">    	   	
        <div class="ym-wbox"> 
        	<div class="submenu nopad">
    <ul class="crossfade ym-clearfix">
        <li class=""><a href="aspnetCompany-Reminders.aspx">Due Invoices</a></li>
        <li class="active"><a href="aspnetCompany-Reminder-UndepositFunds.aspx">Undeposit Funds</a></li>
    ...
    <div class="ym-ie-clearing">&nbsp;</div>
                ...
                <li><a href="#suboption-cash">Cash</a></li>
                <li><a href="#suboption-check">Check</a></li>
                <li><a href="#suboption-card">Card</a></li>
            </ul>
        	<div class="container">
