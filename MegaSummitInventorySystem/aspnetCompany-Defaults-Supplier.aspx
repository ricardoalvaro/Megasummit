<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="aspnetCompany-Defaults-Supplier.aspx.cs" Inherits="MegaSummitInventorySystem.aspnetCompany_Defaults_Supplier" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
...
</div><div id="main" class="company-company-defaults-supplier">
    <div class="ym-wrapper">    	   	
        <div class="ym-wbox"> 
        	<div class="submenu">
                        ...
                        <div class="ym-cbox"> 
                        	<div class="box-holder">             	
                                <div class="content vmiddle">
                                    <div name="company_defaults_supplier_form" class="ym-form">
                                        <table>
                                            <tr>
                                                <td class="lbl"><label for="region_province">*Region Province</label></td>
                                                <td class="obj">
                                                    <div class="select-arrow medium">
                                                        <select name="region_province" id="ddl_region_province">
                                            ...
                                            <tr>
                                                <td class="lbl"><label for="days_of_cancellation">*Days of Cancellation</label></td>
                                                <td class="obj"><input type="text" autocorrect="off" spellcheck="false" id="txt_days_of_cancellation" name="days_of_cancellation" value="30" class="short" /></td>
                                            </tr>                                            
                                        </table>
                                    </div>   
                                </div>                               
    ...
    <div class="ym-cbox"> 
        <ul class="sidebar crossfade">
            ...
            <li class="active"><a href="aspnetCompany-Defaults-Supplier.aspx"><span class="item supplier"></span>Supplier</a></li>
    ...
    <script src="Script/CompanyDefaultSupplier.js"></script>
</asp:Content>
