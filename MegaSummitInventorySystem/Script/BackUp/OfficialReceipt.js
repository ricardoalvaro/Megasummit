        ...
        success: function (response) {
            ...
            if (data.length != 0) {
                for (var i = 0; i < data.length; i++) {
                    ...
                    $('#xInvoiceTable tbody:last').append("<tr><td width='15%'> " + PrefixInitial + "" + RefNoSerial + " </td><td width='15%'>" + CreatedDate + "</td><td width='20%'>" + "" + "</td><td width='20%'>" + Salesman + "</td><td width='15%'><div><input class='balance' style='width: 65px; border: none; background-color: transparent;' value='" + balanceAmount + "'/></div></td><td  width='15%'><div onclick=\"getBalance(this);\"><input class='apply' style='width: 65px; border: none; background-color: transparent;' onblur=\"ComputeApply();\"/></div><input class='salesID' style='width: 77px; border: none; background-color: transparent; display: none;' value=" + ID + " /></td></tr>");
                }
            }
            else {
                $('#xInvoiceTable tbody:last').append("<tr><td width='15%'> " + PrefixInitial + "" + RefNoSerial + " </td><td width='15%'>" + CreatedDate + "</td><td width='20%'>" + "" + "</td><td width='20%'>" + Salesman + "</td><td width='15%'><div><input class='balance' style='width: 65px; border: none; background-color: transparent;' value='" + SubTotalAmt + "'/></div></td><td width='15%'><div onclick=\"getBalance(this);\"><input class='apply' style='width: 65px; border: none; background-color: transparent;' onblur=\"ComputeApply();\"/></div><input class='salesID' style='width: 77px; border: none; background-color: transparent; display: none;' value=" + ID + " /></td></tr>");
            }
        },
        error: function (response) {
            alert(response.status);
