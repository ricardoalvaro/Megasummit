<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="aspnetSupplier.aspx.cs" Inherits="MegaSummitInventorySystem.aspnetSupplier" %>
                                    ...
                                    <asp:Repeater runat="server" ID="repList">
                                        <ItemTemplate>
                                            <tr id="rec-1" onclick="RedirectToGeneralInfomation(<%# Eval("ID") %>)" >
                                                <td width="40%"><%# Eval("SupplierName").ToString() %></td>
                                                <td width="15%"><%# Eval("RegionProvince").ToString() %></td>
                                                <td width="15%"><%# Eval("ContactPerson").ToString() %></td>
                                                <td width="10%"><%# Eval("Telephone").ToString() %></td>
                                                <td width="10%"><%# Eval("Fax").ToString() %></td>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#btn-new").click(function () {
                window.location = "aspnetSupplierInformation.aspx";
            });
        ...
        function RedirectToGeneralInfomation(supplier_id) {
            window.location = "aspnetSupplierInformation.aspx?supplierID=" + supplier_id;
        }
